...
local Presets = {
    ...
    [1] = {
        ...
        cascadingFailureSpeedFactor = 2.0,
    ...
    [2] = {
        ...
        degradingFailureThreshold   = 600.0,
    ...
    [3] = {
        ...
        degradingHealthSpeedFactor  = 8,
        cascadingFailureSpeedFactor = 6.0,
        torqueMultiplierEnabled     = true,
        limpMode                    = false,
    ...
    [5] = {
        ...
        degradingFailureThreshold   = 900.0,
        cascadingFailureThreshold   = 450.0,
        engineSafeGuard             = 80.0,
        degradingHealthSpeedFactor  = 15,
        cascadingFailureSpeedFactor = 12.0,
        torqueMultiplierEnabled     = true,
        limpMode                    = false,
